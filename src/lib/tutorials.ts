    ...
    steps: [
      {
        ...
        description: 'This is your control centre. Monitor team activity, review performance, and manage shifts in real time.',
        placement: 'bottom',
        skipAllowed: true,
      },
      {
        ...
        title: 'Team Chips',
        description: 'Each chip shows a worker and whether they are currently clocked in. Click any chip to see their details.',
        placement: 'bottom',
        skipAllowed: true,
      },
      {
        ...
        title: 'Worker Status Cards',
        description: 'These cards give you a live snapshot — who is working, how many hours logged, and total team activity.',
        placement: 'top',
        skipAllowed: true,
      },
      {
        ...
        description: 'Every clock-in and clock-out appears here instantly. Use this to confirm your team is on schedule.',
        placement: 'top',
        skipAllowed: true,
      },
      {
        ...
        description: 'See today\'s sales totals and revenue per seller at a glance. Identify your top performers.',
        placement: 'top',
        skipAllowed: true,
      },
      {
        ...
        target: '.task-board',
        title: 'Task Board',
        description: 'Assign tasks to your team, set priorities, and track completion. Drag cards between columns to update status.',
        placement: 'top',
        skipAllowed: true,
      },
      {
        ...
        description: 'This section ranks sellers by revenue, orders, and hours. Use it for performance reviews and incentives.',
        placement: 'top',
        skipAllowed: true,
      },
      {
        ...
        target: '.dashboard-content',
        title: 'Alerts Panel',
        description: 'Any unusual activity — missed clock-outs, low stock, or flagged transactions — surfaces here for your review.',
        placement: 'top',
        skipAllowed: true,
      },
      {
        id: 'step-9',
        target: '.activity-approval-list',
        title: 'Approve Activity',
        description: 'Workers\' clock-in and clock-out entries require your approval. Approve to confirm or reject to flag for follow-up.',
        placement: 'top',
        skipAllowed: true,
      },
      {
        ...
        target: '.help-button',
        title: 'Need Help?',
        description: 'Click this button anytime to replay this full tour.',
        placement: 'bottom',
        actionText: 'Got it',
        skipAllowed: false,
      },
    ...
    steps: [
      {
        ...
        description: 'This is your central hub for managing Makay Store. Every tool you need is accessible from here.',
        placement: 'bottom',
        skipAllowed: true,
      },
      {
        id: 'step-2',
        target: '.admin-stats-strip',
        title: 'Live Stats',
        description: 'This strip shows real-time totals — products in your catalog, orders this month, and sellers active today.',
        placement: 'bottom',
        skipAllowed: true,
      },
      {
        ...
        title: 'Products & 3D',
        description: 'Create products and generate 3D models from a single product photo using AI.',
        placement: 'right',
        skipAllowed: true,
      },
      {
        ...
        title: 'Orders',
        description: 'View every order placed by your sellers, filter by seller, and inspect order details.',
        placement: 'right',
        skipAllowed: true,
      },
      {
        ...
        title: 'Users & Roles',
        description: 'Assign roles to every user — customer, seller, supervisor, or admin. Role controls which panel they access.',
        placement: 'right',
        skipAllowed: true,
      },
      {
        id: 'step-6',
        target: '.admin-nav-card:nth-child(4)',
        title: 'Reports',
        description: 'Sales charts, cost/margin analysis, monthly goal tracking, and inventory health — all with real data.',
        placement: 'right',
        skipAllowed: true,
      },
      {
        id: 'step-7',
        target: '.admin-nav-card:nth-child(5)',
        title: 'Product Rotation',
        description: 'Schedule when products cycle between Active, Paused, and Archived. Keep your catalog fresh automatically.',
        placement: 'right',
        skipAllowed: true,
      },
      {
        id: 'step-8',
        target: '.admin-nav-card:nth-child(6)',
        title: 'Storefront Studio',
        description: 'One editor for everything: brand palette, scroll colors, per-page typography, content overrides, product images, and member card design.',
        placement: 'right',
        skipAllowed: true,
      },
      {
        ...
        description: 'The sidebar gives you instant access to all 7 sections — Panel, Products, Orders, Users, Reports, Rotation, and Studio.',
        placement: 'right',
        skipAllowed: true,
      },
      {
    ...
    steps: [
      {
        ...
        title: 'Your Numbers',
        description: 'Revenue, orders, tracked products, and stock units — updated every time you visit.',
        placement: 'bottom',
        skipAllowed: true,
      },
      {
        id: 'step-2',
        target: '.seller-stat-card:first-child',
        title: 'Revenue Card',
        description: 'This is your total revenue from all sales you have processed. It includes all order totals.',
        placement: 'bottom',
        skipAllowed: true,
      },
      {
        ...
        title: 'Quick Actions',
        description: 'Jump straight to selling, managing products, updating stock, or viewing your shift activity.',
        placement: 'top',
        skipAllowed: true,
      },
      {
        id: 'step-4',
        target: '.seller-action-card.primary',
        title: 'Sell to Client',
        description: 'This is your primary tool. Use it to search for a client, add products, and complete a sale in 3 steps.',
        placement: 'right',
        skipAllowed: true,
      },
      {
        id: 'step-5',
        target: '.seller-recent',
        title: 'Recent Sales',
        description: 'Your latest completed sales appear here. Click any row to view the full order details.',
        placement: 'top',
        skipAllowed: true,
      },
      {
        ...
        title: 'Sidebar Navigation',
        description: 'Switch between Sell, Products, Stock, and Activity using the sidebar. Your current section is highlighted.',
        placement: 'right',
        skipAllowed: true,
      },
      {
        ...
        description: 'Click this button anytime to replay this tour. Start by clicking "Sell to Client" to process your first sale.',
        placement: 'bottom',
